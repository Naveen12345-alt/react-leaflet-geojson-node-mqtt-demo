...
var _default = function _default(topic, dispatch, TargetComponent) {
  var _class, _temp;
  ...
  function (_Component) {
    ...
    function _class(props, context) {
      ...
      _this.handler = dispatch.bind(_assertThisInitialized(_this));
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            props = _objectWithoutProperties(_this$props, ["client"]);

        return (0, _react.createElement)(TargetComponent, _objectSpread({}, props, {
